...
describe('/users endpoint', () => {
  ...
  describe('when POST /users', () => {
    ...
    it('should response 400 when request payload not meet data type specification',
        async () => {
          // Arrange
          const requestPayload = {
            username: 'dicoding',
    ...
    it('should response 400 when username contain restricted character',
        async () => {
          // Arrange
          const requestPayload = {
          ...
          expect(response.statusCode).toEqual(400);
          expect(responseJson.status).toEqual('fail');
          const failMsg = 'tidak dapat membuat user baru karena username mengandung karakter terlarang';
          expect(responseJson.message)
              .toEqual(failMsg);
        });
